 ...
 * */
var ngDataAnnotations = angular.module('ngDataAnnotations', []);
 ...
 *      - Values: '<', '<=', '=', '>=', '>', '!='
 * */
ngDataAnnotations.directive('timePropertyCompares', function () {
 ...
 *      - Values: '<', '<=', '=', '>=', '>', '!='
 * */
ngDataAnnotations.directive('textPropertyCompares', function () {
 ...
 *       - Example: '20'
 * */
ngDataAnnotations.directive('numericPropertyCompares', function () {

    // Compare 2 date property base on the operator.
    isNumericPropertyCompareValid = function (source, target, operator, range, mathematicOperator) {

        var flTarget = parseFloat(target);
        var flRange = parseFloat(range);
        var flSource = parseFloat(source);
    ...
    return {
        ...
        link: function (scope, element, attribute, ngModel) {
            ...
            // Watch target property for changes.
            scope.$watchGroup([attribute.numericPropertyCompares], function ()
            {/*$watch(attribute.numericPropertyCompares, function () {*/
 ...
 * */
ngDataAnnotations.directive('textPropertyContains', function () {
    ...
    return {
        ...
        link: function (scope, element, attribute, ngModel) {
            ...
            var comparisionOperator = attribute.textPropertyContainsOperator;
 ...
 * */
ngDataAnnotations.directive('ngFunctionValidate', function(){
